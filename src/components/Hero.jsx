  ...
  return (
    ...
    lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
       ...
       className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px]  max-w-5xl '>
        ...
        <span className='bg-gradient-to-r form-[#5044E5]  to-[#4d8cea] bg-clip-text text-transparent'>  digital </span> impact.
       </motion.h1>
       <motion.p
       initial={{opacity:0,y:20}}
       whileInView={{opacity:1,y:0}}
       ...
       viewport={{once:true}}
       className='text-sm sm:text-lg font-medium text-gray-500 dark:text-while/75 max-w-4/5 sm:max-w-lg pb-3 '>
       ...
       className='relative' >
        ...
        <img src={assets.bgImage1} alt='' className='absolute -top-90 -right-40  sm:-to-100  sm:-right-70 -z-1  daek:hidden'/>
       </motion.div>
    </div>
  )
}
